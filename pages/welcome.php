		...
		<div class="row">
			...
			<div class="col-sm-10 text-center">
				...
				<h3 class="lighter">We are here to help students of Concordia University get the best learning experience.
					...
					Our main goal is to provide Concordia faculty members with a reliable resource to assess their students progression while enabling them to ask questions directly to the professor throught Q&amp;A.
				</h3>
				<br/>
