    ...
    <div class="dashboardcontainer">
        ...
        <div class="dashboardcourseDiv"> 
            ...
            <div class="dashboard_add_new_button_container">
                <a href="index.php?page=teacherCreateAnnouncements" id="createAnnouncementLink"><h2 class="dashboard_add_new_button">+ new announcement</h2></a>
            </div>
        </div>
        ...
        <div class="dashboardcontainer2">
            <div class="leftSmallDiv">
                ...
                <div class="dashboard_add_new_button_container">
                    <a href="index.php?page=teacherCreateQuiz"><h2 class="dashboard_add_new_button">+ new quiz</h2></a>
                </div>
            </div>
