...
<body class="dashboard">
    ...
    <div class="dashboardcontainer">
        <!-- example of course name <div class="dashboardcourse">SOEN 341</div> -->
        ...
        <div class="dashboardcontainer2">
            ...
            <div class="leftSmallDiv">
                ...
                <!--Example using multiple quizes
                 <h2 class="dashboardcoursesub">Quiz 1</h2>
                <h2 class="dashboardcoursesub">Quiz 2</h2>
                <h2 class="dashboardcoursesub" >Quiz 3</h2>
                <h2 class="dashboardcoursesub" >Quiz 4</h2>
                <h2 class="dashboardcoursesub" >Quiz 5</h2>
                <h2 class="dashboardcoursesub">Quiz 6</h2>
                -->
