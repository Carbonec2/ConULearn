    ...
    $.ajax({
        ...
        success: function (object) {
            ...
            for(var i=0;i<objects.length;i++){
                $('#courses_container').html($('#courses_container').html()+'<a href="index.php?page=courseDashboardTeacher&id='+objects[i].id+'&coursename='+objects[i].name+'&Course_id='+objects[i].id+'" class="dashboard_box_link"><div class="dashboard_course_box">'+objects[i].name+'<br/><span class="box_course_semester">Winter 2017</span></div></a>');
            }
